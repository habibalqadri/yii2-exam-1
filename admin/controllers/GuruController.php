    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            }else if($model->load($request->post()) && $model->save() && $guruMataPelajaran->load($request->post()) && $guruMataPelajaran->save()){
                return [
            ...
            */
            if ($model->load($request->post()) && $model->save() && $guruMataPelajaran->load($request->post()) && $guruMataPelajaran->save()) {
                return $this->redirect(['view', 'id' => $model->id]);
                
                return $this->redirect(['view', 'id' => $guruMataPelajaran->id]);
